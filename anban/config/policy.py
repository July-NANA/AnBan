...
# MCP stdio servers and protocol messages remain bounded independently from Process output.
MCP_SERVERS_MAX = 8
MCP_ARGUMENTS_MAX = 64
MCP_ENVIRONMENT_MAX = 16
MCP_REQUEST_TIMEOUT_DEFAULT_SECONDS = 60
MCP_REQUEST_TIMEOUT_MIN_SECONDS = 1
MCP_REQUEST_TIMEOUT_MAX_SECONDS = 300
MCP_OUTPUT_MAX_BYTES = 65_536
...
# Authenticated Webhook ingress remains bounded before JSON parsing or Interaction admission.
WEBHOOK_ENDPOINTS_MAX = 8
WEBHOOK_BODY_MAX_BYTES = 32_768
WEBHOOK_BODY_HARD_MAX_BYTES = 262_144
WEBHOOK_CLOCK_SKEW_DEFAULT_SECONDS = 300
WEBHOOK_CLOCK_SKEW_MIN_SECONDS = 1
WEBHOOK_CLOCK_SKEW_MAX_SECONDS = 900
WEBHOOK_SECRET_MIN_BYTES = 32
WEBHOOK_EVENT_ID_MAX_CHARS = 128
