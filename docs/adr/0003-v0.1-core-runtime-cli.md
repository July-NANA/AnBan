...
- Status: Accepted; amended by Gate #28 uniform Skill/Process remediation
- Date: 2026-07-17
...
- Skills use one source-independent `SKILL.md` parser and `skill.activate`; all concrete program,
  file, network, and package operations use the general `process.execute` channel.
...
-> real Model Port
-> real uniformly discovered Skill
-> real general Process Capability
...
fallback, or a dedicated Skill installation Capability. ClawHub is ordinary Skill knowledge.
